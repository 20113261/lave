...
def convert_m_flight_to_roundflight(mflight):
    ...
    rf.dept_day = out_dept_seg.dept_date.strftime(FOR_FLIGHT_DATE)
    rf.dest_day = out_dest_seg.dest_date.strftime(FOR_FLIGHT_DATE)
    ...
    rf.flight_no_A, rf.plane_no_A, rf.plane_no_A, rf.seat_type_A, \
        rf.real_class_A, rf.stop_id_A, rf.stop_time_A, rf.daydiff_A = leg_join(leg_outbound)

    rf.flight_no_B, rf.plane_no_B, rf.plane_no_B, rf.seat_type_B, \
        rf.real_class_B, rf.stop_id_B, rf.stop_time_B, rf.daydiff_B = leg_join(leg_outbound)

    rf.dept_time_A = out_dept_seg.dept_date.strftime(FOR_FLIGHT_DAY)
    rf.dept_time_B = in_dept_seg.dept_date.strftime(FOR_FLIGHT_DAY)

    rf.dest_time_A = out_dept_seg.dest_date.strftime(FOR_FLIGHT_DAY)
    rf.dest_time_B = in_dept_seg.dest_date.strftime(FOR_FLIGHT_DAY)
