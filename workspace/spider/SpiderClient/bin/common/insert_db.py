...
def InsertFlightInfo(args):
    ...
    for arg in args:
        ...
        stop_time = arg[-5]
        daydiff = arg[-4]
        new_args.append((flight_no, plane_type, flight_corp, dept_id, dest_id, dept_time, dest_time, during, stop_id, stop_time, daydiff))
...
if __name__=='__main__':
    InsertFlightInfo([('KL231', '320', 'british air', 'PEK', 'CDG', '15:00:00', '16:00:00', 20000, 'PEK_LHR|LHR_CDG', 'dfdfdf', '1_0')])
